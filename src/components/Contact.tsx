      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:+34696742513" className="text-2xl font-display font-medium text-brand-dark hover:text-brand-green-dark transition-colors">
                    +34 696 742 513
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="https://wa.me/34696742513" target="_blank" rel="noopener noreferrer" className="text-2xl font-display font-medium text-brand-dark hover:text-brand-green-dark transition-colors">
                    +34 696 742 513
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:diegotaxi11@gmail.com" className="text-lg font-display font-light text-brand-dark hover:text-brand-green-dark transition-colors">
                    diegotaxi11@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-display font-light text-brand-dark">
                    11160 Barbate<br/>Cádiz, Andalucía
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <p className="text-lg text-brand-dark/70 font-light mb-12 max-w-lg">
              {t.contact.bookDesc}
            </p>
